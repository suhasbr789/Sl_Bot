...
# Bot information
API_ID = environ.get('API_ID', '21669638')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6346712450:AAHcfrK4VHaETdZsEzVQrfS5vASrqDms76A')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6977859652 2038847704')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002097324421 -1002137961726').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002044669778').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002126792745')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', 'cinemaduniyasupport')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://comfymoviez:double@cluster0.z257uji.mongodb.net/")
...
URL = environ.get("URL", "https://fsubbots.onrender.com/")
if len(URL) == 0:
